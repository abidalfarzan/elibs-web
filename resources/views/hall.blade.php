...
@section('content')
    ...
    <div class="max-w-4xl mx-auto mb-18">
        ...
        <div class="text-center mt-4">
            <h3 class="text-2xl font-bold"><a class="text-gray-900 hover:text-blue-500" href="#">Negeri Di Ujung Tanduk</a></h3>
            <div class="flex justify-center items-center text-gray-600 text-sm gap-4 mt-2">
                <span class="flex items-center gap-1"><i class="fa-solid fa-user text-blue-600"></i> <a href="#" class="hover:text-blue-500">Tere Liye</a></span>
                <span class="flex items-center gap-1"><i class="fa-solid fa-bookmark text-green-500"></i> <a href="#" class="hover:text-blue-500">Novel</a></span>
                <span class="flex items-center gap-1"><i class="fa-solid fa-clock text-yellow-300"></i> 2 Hours ago</span>
            </div>
            <p class="text-gray-700 mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi nemo vero tempore.</p>
                ...
                <div class="bg-white shadow-md rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center text-gray-600 text-sm gap-4 mt-2">
                            <span class="flex items-center gap-1"><i class="fa-solid fa-user text-blue-600"></i> <a href="#" class="hover:text-blue-500">{{ $book['author'] }}</a></span>
                            <span class="flex items-center gap-1"><i class="fa-solid fa-clock text-yellow-300"></i> {{ $book['time'] }}</span>
                        </div>
                        <p class="text-gray-700 mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus corrupti aliquid nesciunt vitae.</p>
                        <a href="#" class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Read more</a>
                    </div>
                </div>
            @endforeach
