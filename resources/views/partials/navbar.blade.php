    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('/') ? 'bg-gray-900 text-white' : 'hover:bg-gray-700 hover:text-white'}}" aria-current="page">Homepage</a>
                <a href="/hall" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('hall*') ? 'bg-gray-900 text-white' : 'hover:bg-gray-700 hover:text-white'}}" aria-current="page">Hall</a>
                <a href="/about" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->is('about*') ? 'bg-gray-900 text-white' : 'hover:bg-gray-700 hover:text-white'}}" aria-current="page">About</a>
            </div>
            </div>
        </div>
        <div class="hidden md:block">
