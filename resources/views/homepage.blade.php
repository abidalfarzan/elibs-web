        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="grid max-w-md grid-cols-1 mx-auto mt-12 lg:max-w-full lg:mt-16 lg:grid-cols-3 gap-x-16 gap-y-12">
                ...
                <div>
                    ...
                    <span class="inline-flex px-4 py-2 text-xs font-semibold tracking-widest uppercase rounded-full text-rose-500 bg-rose-100 {{ $book->category_color }} mt-9">
                        {{ $book->category->name }}
                    </span>
                    <p class="mt-6 text-xl font-semibold">
                        <a href="#" title="" class="text-black"> {{ $book->name }} </a>
                    </p> {{ Str::limit($book->body, 100) }} </p>
